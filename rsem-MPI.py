...
def pre_process(tr,inventory,freqmin,freqmax):
...
for i in range(start_position,start_position+share):
	...
	tr.stats['network'] = 'TC'
	tr.stats['station'] = 'CVTR'
	tr.stats['channel'] = 'HHZ'
	
	pre_process(tr,inventory,freqmin,freqmax)
...
if rank == 0:
	...
	print(end-start)
	print('\n========================================================================\n')
	print('Total time of execution (without importing modules) {} s'.format(round(end-start)))